#!/usr/bin/env bash
# Phase 5 CI and module-path audit for droid-proxy public release.
set -euo pipefail
...
info "Starting Phase 5 CI audit in ${ROOT}"
...
info "MANUAL (5): enable GitHub secret scanning and branch protection after going public"
info "MANUAL (5): tag v0.1.0 after orphan-branch publish"
