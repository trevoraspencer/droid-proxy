...
- Curated provider profiles for Anthropic, OpenAI, DeepSeek, Xiaomi MiMo, xAI, Kimi, Z.AI, Groq, Fireworks, Baseten, Ollama, and vLLM.
...
droid-proxy is an independent open-source project. It is not affiliated with, endorsed by, or officially supported by [Factory AI](https://factory.ai), OpenAI, Anthropic, DeepSeek, xAI, Xiaomi, Moonshot AI, Z.AI, Groq, Fireworks, Baseten, Ollama, vLLM, or any other provider named in the documentation. Factory Droid and provider names are trademarks of their respective owners.
